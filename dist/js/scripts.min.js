...
$(document).ready(function () {
  ...
  function appendQuestion(dataObj) {
    ...
    $(DOMStrings.contentWrap).append("<img src=\"".concat(dataObj[currentQuestion]['img'], "\">"));
  }
  ...
  function viewConclusion() {
    ...
    $('.test-popup__content').prepend("<span class=\"test-result\">\u0412\u0430\u0448 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442:</span>\n                                        <span class=\"test-result-count\"><strong>".concat(allAnswers, "<strong> \u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u044B\u0445 \u043E\u0442\u0432\u0435\u0442\u0430 \u0438\u0437 <strong>").concat(dataLength - 1, "<strong></span>"));

    function viewresulttext(dataObj) {
      if (allAnswers < 5) {
        $(DOMStrings.contentWrap).append("<div class=\"result-text\">".concat(dataObj[dataLength - 1]['totals'][2], "</div>"));
      } else if (allAnswers >= 5 && allAnswers <= 7) {
        $(DOMStrings.contentWrap).append("<div class=\"result-text\">".concat(dataObj[dataLength - 1]['totals'][1], "</div>"));
      } else if (allAnswers >= 8 && allAnswers <= 10) {
        $(DOMStrings.contentWrap).append("<div class=\"result-text\">".concat(dataObj[dataLength - 1]['totals'][0], "</div>"));
      }
    }
  ...
  function checkAnswer(dataObj) {
    var correctTemplate = "\n                          <div class=\"is-correct-wrap\">\n                            <span class=\"is-correct-title\">\u041F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u043E</span>\n                            <p class=\"is-correct-text\">".concat(dataObj[currentQuestion]['correctText'], "</p>\n                          </div>\n                        ");
    var errorTemplate = "\n                          <div class=\"is-correct-wrap\">\n                            <span class=\"is-error-title\">\u041D\u0435 \u0432\u0435\u0440\u043D\u043E</span>\n                            <p class=\"is-correct-text\">".concat(dataObj[currentQuestion]['wrongText'], "</p>\n                          </div>\n                        ");
    console.log(answer);
